...
void St3215Servo::setup() {
  ...
  // v0.6: po bootu je poslední uložená poloha zdroj pravdy.
...
void St3215Servo::update() {
  ...
  if (!startup_synced_) {
    ...
    // v0.6: navázání enkodéru na poslední uloženou pozici.
    ...
    ESP_LOGI(TAG, "Startup sync OK v0.6: raw=%u logical=%u frac=%.3f saved_before=%.3f current=%.3f zero=%.3f total=%.3f reads=%u",
  ...
  // v0.6: pozici vedeme inkrementálně od uložené pos, ne absolutně z raw.
